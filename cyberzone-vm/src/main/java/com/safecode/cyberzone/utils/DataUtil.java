...
public final class DataUtil {
	...
	public static final Integer parseInteger(double s){
	...
	/**
	 * 整数value除以div结果按保留两位小数返回
	 * @param value
	 * @param div
	 * @return
	 */
	public static final String getIntegerDiv(int value, int div){
		double d = value*1.0/div;
