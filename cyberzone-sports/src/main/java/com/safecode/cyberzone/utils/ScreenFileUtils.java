...
public class ScreenFileUtils {
     ...
     * @return
     */
    public String headphotoupdownload(MultipartFile logophoto,String path) throws IOException {
     ...
     //   String filepath = "/home/hmj/saveFile/corpsPhoto/" + y + m + d + h + mi + s + ".jpg";
        String filepath = path + y + m + d + h + mi + s + ".jpg";
