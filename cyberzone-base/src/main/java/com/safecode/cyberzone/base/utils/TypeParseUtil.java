...
import com.safecode.cyberzone.base.support.DataType;
...
public final class TypeParseUtil {
	 ...
	 * @throws Exception
	 */
	public static final Object convert(Object value, Class<?> type, String format) throws Exception {
	 ...
	 * @throws Exception
	 */
	public static final Object convert(Object value, String type, String format) throws Exception {
		...
		if (value == null) {
			...
			throw new Exception(String.format(support, value.getClass().getName(), type));
		}
	}

	// 布尔类型
	private static Object bool2Obj(Object value, String type) throws Exception {
		...
		if ("Boolean".equalsIgnoreCase(type) || DataType.BOOLEAN.equalsIgnoreCase(type)) {
			...
			throw new Exception(String.format(support, fromType, type));
		}
	}

	// 时间类型
	private static Object time2Obj(Object value, String type, String format) throws Exception {
	...
	// 日期类型
	private static Object sqlDate2Obj(Object value, String type, String format) throws Exception {
	...
	// 时间类型
	private static Object date2Obj(Object value, String type, String format) throws Exception {
		String fromType = "Date";
	...
	// 整形
	private static Object intr2Obj(Object value, String type, Locale locale) throws Exception {
	...
	// 长整型
	private static Object long2Obj(Object value, String type, Locale locale) throws Exception {
	...
	private static Object float2Obj(Object value, String type, Locale locale) throws Exception {
	...
	// 双精度浮点型
	private static Object double2Obj(Object value, String type, Locale locale) throws Exception {
	...
	// 数字型
	private static Object decimal2Obj(Object value, String type, Locale locale) throws Exception {
	...
	// 字符型
	private static Object string2Object(Object value, String type, String format, Locale locale) throws Exception {
				...
				if (format == null || format.length() == 0)
					try {
						...
						try {
							...
							throw new Exception(String.format(message, str, type), e);
						}
					}
				SimpleDateFormat sdf = new SimpleDateFormat(format);
				java.util.Date fieldDate = sdf.parse(str);
	...
	/** 转换为布尔值 
	 * @throws Exception */
	public static final Boolean convertToBoolean(Object obj) throws Exception {
		return (Boolean) convert(obj, "Boolean", null);
	}

	/** 转换为整型 
	 * @throws Exception */
	public static final Integer convertToInteger(Object obj) throws Exception {
	...
	/** 转换为字符串 
	 * @throws Exception */
	public static final String convertToString(Object obj, String defaultValue) throws Exception {
	...
	/** 转换为长整型 
	 * @throws Exception */
	public static final Long convertToLong(Object obj) throws Exception {
		return (Long) convert(obj, "Long", null);
	}

	/** 转换为双精度型 
	 * @throws Exception */
	public static final Double convertToDouble(Object obj) throws Exception {
		return (Double) convert(obj, "Double", null);
	}

	/** 转换为浮点型 
	 * @throws Exception */
	public static final Double convertToFloat(Object obj) throws Exception {
		return (Double) convert(obj, "Float", null);
	}

	/** 转换为数值型 
	 * @throws Exception */
	public static final BigDecimal convertToBigDecimal(Object obj, int scale) throws Exception {
		return ((BigDecimal) convert(obj, "BigDecimal", null)).setScale(scale, 5);
	}

	/** 转换为日期型 
	 * @throws Exception */
	public static final java.util.Date convertToDate(Object obj, String format) throws Exception {
		return (java.util.Date) convert(obj, "Date", format);
	}

	/** 转换为日期型 
	 * @throws Exception */
	public static final Date convertToSqlDate(Object obj, String format) throws Exception {
		return (Date) convert(obj, "java.sql.Date", format);
	}

	/** 转换为日期型 
	 * @throws Exception */
	public static final Timestamp convertToTimestamp(Object obj, String format) throws Exception {
