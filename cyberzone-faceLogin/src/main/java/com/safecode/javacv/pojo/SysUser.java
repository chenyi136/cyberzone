package com.safecode.javacv.pojo;
...
public class SysUser implements Serializable{
    ...
    public String toString() {
        ...
        sb.append(", facePerm=").append(facePerm);
    ...
    public boolean equals(Object that) {
        ...
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getFacePerm() == null ? other.getFacePerm() == null : this.getFacePerm().equals(other.getFacePerm()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getFacePerm() == null) ? 0 : getFacePerm().hashCode());
